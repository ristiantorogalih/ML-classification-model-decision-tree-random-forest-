...
+ cocok untuk prediktor2 yang bertipe kategorikal/factor, kalau numerik akan diubah menjadi faktor (binning)
+ cocok untuk teks klasifikasi
- skewness due data scarcity (kemunculan salah satu prediktor 0 di suatu kelas): cara mengatasinya dengan laplace
- mengasumsikan variabel2 prediktornya independent, kurang cocok untuk data dengan variabel2 prediktor yang dependent
